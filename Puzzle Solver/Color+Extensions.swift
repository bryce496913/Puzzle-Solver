...
enum PuzzleAvailabilityCatalog {
    static let all: [PuzzleAvailabilityDescriptor] = [
        ...
        PuzzleAvailabilityDescriptor(id: "sudoku-photo-scan", category: .logic, title: "Sudoku Photo Scan", shortDescription: "Scan a paper Sudoku or import a photo to fill the puzzle grid automatically.", icon: "camera.viewfinder", status: .active),
