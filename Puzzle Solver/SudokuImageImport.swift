...
struct SudokuScanResult: Equatable, Identifiable {
    ...
    var board: SudokuBoard {
        ...
        for cell in cells where (0..<SudokuBoard.dimension).contains(cell.row) && (0..<SudokuBoard.dimension).contains(cell.column) && SudokuBoard.validDigits.contains(cell.recognizedValue ?? 0) {
