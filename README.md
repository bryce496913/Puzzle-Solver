...
- Version 1 onboarding, settings, Dynamic Type-friendly UI, dark-mode polish, bounded loading states, and TestFlight release metadata.
...
| Pyraminx / Skewb | Bounded Version 1 solver paths are available. |
...
## Version 1 TestFlight Checklist
